...
public class BasicController {
    ...
    @RequestParam(required = false,name="page",defaultValue = "1") String page
        ...
        Page<Post>posts_on_page=postserv.findAll(Integer.parseInt(page)-1, Integer.parseInt(per_page), sort_by);
         ...
         if(pages!=null){
            for(int link:pages){
                ...
                String _temp_link="/home?per_page="+per_page+"&page="+(link+1)+"&sort_by="+sort_by;
